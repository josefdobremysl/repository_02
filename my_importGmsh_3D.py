...
#===============================================================================================================================================================================================
    def readMesh(self, meshfile):
        ...
        self.nodeXY = self.nodeCoord[:,[0,1,2]]        
        ...
        self.nTetra = self.nElmts[4] # 2 je typ trojuhelniku
        print('self.nTetra:',self.nTetra)
        self.tetrahedron = self.Elmts[4][1] # pole vrcholu jednotlivych troj.
        print('self.tetrahedron:',self.tetrahedron)
        self.tetraTag = self.Elmts[4][0] # seznam indexu jednotlivych troj.
        print('self.tetraTag:',self.tetraTag)
